                ...
                CarouselColumn(
                    ...
                    actions=[
                        ...
                        URITemplateAction(
                            label='workpaper',
                            #改成你的作業連結
                            uri="https://drive.google.com/open?id=1Y0PcqPlaV1UBll3rZ11v_MD880aLlEfE" 
                        )
                    ]
                ),
                   ]
          ...
          "contents": [
            {
              ...
              "action": {
                "type": "uri",
                "uri": "https://www.cakeresume.com/s--bQkdEJfpfnoGFtWrpRdhNQ--/harry10148"
              }
            },
            {
              "type": "separator",
            ...
            },
            {
              ...
              "action": {
                "type": "uri",
                "uri": "https://www.cakeresume.com/s--9117jgHbIVx6KAdDgJYTwg--/li-cha-hao"
              }
            },
            {
              "type": "separator",
            ...
            {              
              ...
              "action": {
                "type": "uri",
                "uri": "https://github.com/harry10148"
              }
            }
          ]
        }
...
def handle_message(event):
    ...
    if (event.message.text.find('我想看李家豪vSphere講解')!= -1):
        ...
        url3='https://drive.google.com/open?id=19_GbQplL7vvCMK2vlR69HL6dh5WjFoLU'
        # 將上面的變數包裝起來
        reply_list = [
    ...
    # 當用戶輸入Linux Server時判斷成立
        ...
        url2='https://drive.google.com/open?id=1bkjc3DQVwdiYRm6ELOngsv6VgdBBa_u9'
        # 將上面的變數包裝起來
        reply_list = [
            TextSendMessage(text="專題簡報:\n%s" % (url2)),
        ...
        url3='https://drive.google.com/open?id=1I9MiQpDDZxsj5aA3-vmeISZoc1_p0jeUT4S5LATAhtc'
        url4='https://drive.google.com/open?id=1r9c2vK-XHZpTt2Ime_MDyJKdSUvBtvno'
        url5='https://drive.google.com/open?id=16M713nSX9N1EVXJ2W5GvypN7tVSNdcnz'
        # 將上面的變數包裝起來
        reply_list = [
            TextSendMessage(text="在資策會裡學習了關於大量網路相關知識，其中也包括大量的實作"),
            TextSendMessage(text="TLS1.2與TLS1.3之差別:\n%s" % (url1)),
            TextSendMessage(text="DNSSEC調研:\n%s" % (url2)),
            TextSendMessage(text="ICMP的應用:\n%s" % (url3)),
            TextSendMessage(text="Packet Tracer 練習檔:\n%s" % (url4)),
            TextSendMessage(text="Docker練習:\n%s" % (url5))   
        ]
        # 回覆訊息
        line_bot_api.reply_message(
            event.reply_token,
